...
A diferencia de `barplot`, `Barplot`tiene como argumento de entrada un vector de clase _factor_ o de clase _character_. Recuerde, el resultado obtenido con `Barplot` se puede replicar también en la interfaz de RCommander.
...
**EJERCICIO** El gráfico anterior se generó con el paquete **graphics**, que está preinstalado en `R`. Grafique un bocplot en RCOmmander.
