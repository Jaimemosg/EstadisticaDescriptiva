...
La tabla es un objeto de clase _table_. Los objetos `table` y `xtabs` tiene como métodos algunas operaciones matriciales. Por ello, es sencillo construir la tabla de frecuencias relativas (en porcentaje). Por ejemplo, con el objeto `xtable`:
